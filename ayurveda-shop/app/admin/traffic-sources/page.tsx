  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-8">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="text-blue-700 dark:text-blue-400 max-w-md">
            Traffic source analytics is not yet implemented in the backend. This feature will provide insights into organic, direct, referral, and social traffic.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {['Organic Search', 'Direct', 'Referral', 'Social Media'].map((source) => (
          <div key={source} className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 opacity-50">
