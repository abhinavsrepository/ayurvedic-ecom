...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Image uploaded successfully', type: upload_response_dto_1.UploadResponseDto }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Images uploaded successfully', type: [upload_response_dto_1.UploadResponseDto] }),
    (0, swagger_1.ApiResponse)({ status: 400, description: 'Bad request' }),
    (0, swagger_1.ApiResponse)({ status: 401, description: 'Unauthorized' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Forbidden' }),
