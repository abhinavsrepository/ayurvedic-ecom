...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Upload ID' }),
...
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Thumbnail URL (if generated)' }),
    __metadata("design:type", String)
], UploadResponseDto.prototype, "thumbnailUrl", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'S3 key' }),
    __metadata("design:type", String)
], UploadResponseDto.prototype, "s3Key", void 0);
__decorate([
...
], UploadResponseDto.prototype, "sizeBytes", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'MIME type' }),
    __metadata("design:type", String)
], UploadResponseDto.prototype, "mimeType", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Image width (if image)' }),
    __metadata("design:type", Number)
], UploadResponseDto.prototype, "width", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ description: 'Image height (if image)' }),
    __metadata("design:type", Number)
