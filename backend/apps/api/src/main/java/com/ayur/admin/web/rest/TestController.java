...
/** Test controller to help debug authentication issues DELETE THIS FILE IN PRODUCTION! */
@RestController
...
public class TestController {
  ...
  /** Generate a BCrypt hash for a given password Use this to verify password hashing */
