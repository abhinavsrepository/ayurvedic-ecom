...
public class OrderController {
  ...
  @Operation(
      ...
      description = "Get full order details including items and timeline")
  @PreAuthorize("hasAnyRole('ADMIN', 'OPS', 'FINANCE')")
  ...
  public ResponseEntity<RefundResponse> processRefund(
      @PathVariable UUID orderId, @Valid @RequestBody RefundRequest request) {
  ...
  @Operation(
      ...
      description = "Export orders to CSV with streaming response")
  @PreAuthorize("hasAnyRole('ADMIN', 'OPS', 'FINANCE')")
