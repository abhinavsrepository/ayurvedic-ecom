...
public class ProductService {
  ...
  public Page<ProductResponse> listProducts(
      Pageable pageable, String search, String status, String category) {
  ...
  public ProductController.MediaUploadResponse getMediaUploadUrl(
      UUID productId, String fileName, String contentType) {
